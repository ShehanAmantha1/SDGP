  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // gallerypagefDr (17:2)
        padding:
            EdgeInsets.fromLTRB(10 * fem, 280 * fem, 10 * fem, 49.17 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 139 * fem, 48 * fem),
              width: double.infinity,
              child: Row(
                          ...
                          child: TextButton(
                            ...
                            child: Container(
                              padding: EdgeInsets.fromLTRB(
                                  27 * fem, 35.38 * fem, 31 * fem, 36.38 * fem),
                              width: double.infinity,
                              decoration: BoxDecoration(
            ...
            Container(
              // group10EiC (17:21)
              margin:
                  EdgeInsets.fromLTRB(143 * fem, 0 * fem, 139 * fem, 25 * fem),
              child: TextButton(
                onPressed: () {
                ...
                child: Container(
                  padding: EdgeInsets.fromLTRB(
                      28.38 * fem, 28.43 * fem, 24.38 * fem, 23.43 * fem),
                  width: double.infinity,
                  decoration: BoxDecoration(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(103 * fem, 0 * fem, 104 * fem, 0 * fem),
              width: double.infinity,
              height: 33.83 * fem,
              decoration: BoxDecoration(
